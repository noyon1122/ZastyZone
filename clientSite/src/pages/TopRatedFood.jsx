        ...
        <div className='grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4'>
            <div className=' bg-white'>
                 <div className='flex flex-col justify-center items-center my-5'>
                    <h1 className='text-xl font-medium'>Single Fresh Burger</h1>
                    <h1 className='text-xl font-medium text-red-600'>Price $55</h1>
              ...
              <path d="M20.924 7.625a1.523 1.523 0 0 0-1.238-1.044l-5.051-.734-2.259-4.577a1.534 1.534 0 0 0-2.752 0L7.365 5.847l-5.051.734A1.535 1.535 0 0 0 1.463 9.2l3.656 3.563-.863 5.031a1.532 1.532 0 0 0 2.226 1.616L11 17.033l4.518 2.375a1.534 1.534 0 0 0 2.226-1.617l-.863-5.03L20.537 9.2a1.523 1.523 0 0 0 .387-1.575Z"/>
               ...
               <span className="bg-blue-100 text-blue-800 text-xs font-semibold px-2.5 py-0.5 rounded ms-3">5.0</span>
                ...
                <img className=' h-52' src={burger} alt="" />
                </div>
            </div>
            <div className=' bg-white'>
                 <div className='flex flex-col justify-center items-center my-5'>
            ...
            <div className=' bg-white'>
              ...
              <path d="M20.924 7.625a1.523 1.523 0 0 0-1.238-1.044l-5.051-.734-2.259-4.577a1.534 1.534 0 0 0-2.752 0L7.365 5.847l-5.051.734A1.535 1.535 0 0 0 1.463 9.2l3.656 3.563-.863 5.031a1.532 1.532 0 0 0 2.226 1.616L11 17.033l4.518 2.375a1.534 1.534 0 0 0 2.226-1.617l-.863-5.03L20.537 9.2a1.523 1.523 0 0 0 .387-1.575Z"/>
               ...
               <span className="bg-blue-100 text-blue-800 text-xs font-semibold px-2.5 py-0.5 rounded ms-3">5.0</span>
                ...
                <div className='pb-10 w-full  flex justify-center items-center'>
                <img className=' ' src={FriedChicken} alt="" />
                </div>
            </div>
            <div className=' bg-white'>
                 <div className='flex flex-col justify-center items-center my-5'>
            ...
            <div className=' bg-white'>
              ...
              <path d="M20.924 7.625a1.523 1.523 0 0 0-1.238-1.044l-5.051-.734-2.259-4.577a1.534 1.534 0 0 0-2.752 0L7.365 5.847l-5.051.734A1.535 1.535 0 0 0 1.463 9.2l3.656 3.563-.863 5.031a1.532 1.532 0 0 0 2.226 1.616L11 17.033l4.518 2.375a1.534 1.534 0 0 0 2.226-1.617l-.863-5.03L20.537 9.2a1.523 1.523 0 0 0 .387-1.575Z"/>
               ...
               <span className="bg-blue-100 text-blue-800 text-xs font-semibold px-2.5 py-0.5 rounded ms-3">5.0</span>
                ...
                <div className='pb-10 w-full  flex justify-center items-center'>
                <img className=' ' src={Sandwich} alt="" />
                </div>
            </div>
            <div className=' bg-white'>
                 <div className='flex flex-col justify-center items-center my-5'>
            ...
            <div className=' bg-white'>
              ...
              <path d="M20.924 7.625a1.523 1.523 0 0 0-1.238-1.044l-5.051-.734-2.259-4.577a1.534 1.534 0 0 0-2.752 0L7.365 5.847l-5.051.734A1.535 1.535 0 0 0 1.463 9.2l3.656 3.563-.863 5.031a1.532 1.532 0 0 0 2.226 1.616L11 17.033l4.518 2.375a1.534 1.534 0 0 0 2.226-1.617l-.863-5.03L20.537 9.2a1.523 1.523 0 0 0 .387-1.575Z"/>
               ...
               <span className="bg-blue-100 text-blue-800 text-xs font-semibold px-2.5 py-0.5 rounded ms-3">5.0</span>
                ...
                <div className='pb-10 w-full  flex justify-center items-center'>
                <img className=' ' src={SpringRoll} alt="" />
                </div>
            </div>
